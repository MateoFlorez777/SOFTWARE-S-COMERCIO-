    ...
    <>
      ...
      <TableContainer component={Paper}>
        <Table sx={{ minWidth: 700 }} aria-label="customized table">
          <TableHead>
            <TableRow>
              <StyledTableCell>ID del pedido</StyledTableCell>
              <StyledTableCell>Productos</StyledTableCell>
              <StyledTableCell>Dirección de envío</StyledTableCell>
              <StyledTableCell align="right">Estado del pedido</StyledTableCell>
                    ...
                    {item.orderItems.map((orderItem: OrderItem) =>
                      <div key={orderItem.id} className='flex gap-5'>
                        ...
                        <div className='flex flex-col justify-between py-2'>
                          <h1>Título: {orderItem.product.title}</h1>
                          <h1>Precio: Rs.{orderItem.product.sellingPrice}</h1>
                          <h1>Color: {orderItem.product.color}</h1>
                          <h1>Tamaño: {orderItem.size}</h1>
                        </div>
                      </div>
                    )}
                  </div>
