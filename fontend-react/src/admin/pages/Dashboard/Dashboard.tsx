    ...
    <>
      ...
      >
        <Alert
          ...
          sx={{ width: '100%' }}
        >
          {deal.error ? deal.error : deal.dealCreated ? "Oferta creada exitosamente" : deal.dealUpdated ? "Oferta actualizada exitosamente" : admin.categoryUpdated?"Categoría actualizada exitosamente": ""}
        </Alert>
      </Snackbar>
    </>
