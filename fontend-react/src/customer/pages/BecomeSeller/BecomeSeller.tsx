    ...
    <div className="grid md:gap-10 grid-cols-3 min-h-screen ">
      <section className="lg:col-span-1 md:col-span-2 col-span-3  p-10 shadow-lg rounded-b-md">
        ...
        <div className='mt-10 space-y-2'>
          <h1 className='text-center text-sm font-medium'>{isLoginPage && "Don't"} tienes una cuenta? </h1>
          <Button onClick={() => setIsLoginPage(!isLoginPage)} fullWidth sx={{ py: "11px" }} variant='outlined'>{isLoginPage ? "Registrarse" : "Iniciar sesión"}</Button>
        </div>
