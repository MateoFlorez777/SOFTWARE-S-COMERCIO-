        ...
        <div className="w-full lg:w-[80%] space-y-5">
          <div className="flex justify-between items-center px-9 h-[40px]">
            ...
            <FormControl size="small" sx={{ width: "200px" }}>
              <InputLabel id="sort">Orden</InputLabel>
              <Select
                labelId="sort"
                id="sort"
                value={sort}
              ...
              >
                <MenuItem value={"Precio bajo"}>Precio : Bajo - Alto</MenuItem>
                <MenuItem value={"Precio alto"}>Precio : Alto - Bajo</MenuItem>
              </Select>
            </FormControl>
          </div>
          <Divider />
