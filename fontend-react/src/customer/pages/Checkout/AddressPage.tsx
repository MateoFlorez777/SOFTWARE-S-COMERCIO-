...
const paymentGatwayList = [
    {
        value: "MERCADO_PAGO",
        image: "https://belvo.com/wp-content/uploads/2023/07/mercado-pago-logo.png",
        label: "Mercado Pago"
    }
]
const AddressPage = () => {
            ...
            <div className='space-y-5 lg:space-y-0 lg:grid grid-cols-3 lg:gap-9 '>
                ...
                <div className="col-span-2 space-y-5">
                    ...
                    <div className='flex justify-between items-center'>
                        <span className='font-semibold'>Seleccionar dirección de entrega</span>
                        <Button onClick={handleOpen} variant='outlined'>Agregar nueva dirección</Button>
                    ...
                    <div className='py-4 px-5 rounded-md border'>
                        ...
                        <Button onClick={handleOpen} startIcon={<AddIcon />}>Agregar nueva dirección</Button>

                    </div>
                </div>
                <div className="col-span-1 text-sm space-y-3 ">
                    <section className='space-y-3 border p-5 rounded-md'>
                        <h1 className='text-primary-color font-medium pb-2 text-center'>Elegir método de pago</h1>
